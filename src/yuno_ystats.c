 ...
 *          Register
 ***************************************************************************/
PUBLIC void register_yuno_ystats(void)
{
    GCLASS *gclass;
     ...
     */
    gclass = gobj_subclass_gclass(gclass_default_yuno(), GCLASS_YUNO_YSTATS_NAME);
    ...
    gobj_register_yuno(ROLE_YSTATS, gclass, TRUE);
}
